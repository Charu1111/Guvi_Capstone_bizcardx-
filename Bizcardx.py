...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Charu333', auth_plugin='mysql_native_password')
...
icon = Image.open("D:\\Guvi_project\\Bizcardx.py\\ICON.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By CHARULATHA",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *CHARULATHA*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("D:\\Guvi_project\\Bizcardx.py\\ICON.png"), width=500)
